...
mock:
	...
	mockgen -package mockwk -destination worker/mock/distributor.go github.com/vanhung4499/simplebank/worker TaskDistributor
...
.PHONY: postgres createdb dropdb migrateup migratedown migrateup1 migratedown1 new_migration db_docs db_schema sqlc test server mock proto evans